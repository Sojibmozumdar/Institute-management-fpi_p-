                 ...
                 <form action="{{ route('student_info.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row g-4">
                         <div class="col-md-6">
                             ...
                             <input type="text" name="student_name" class="form-control custom-input"
                                 placeholder="e.g. Rakib Hasan" required>
                         </div>

                         <div class="col-md-6">
                             <label class="form-label fw-semibold">Roll Number</label>
                             <input type="text" name="student_roll" class="form-control custom-input"
                         ...
                         <div class="col-md-4">
                             ...
                             <div class="d-flex gap-3 mt-2">
                                 <div class="form-check">
                                     <input class="form-check-input" type="radio" name="shift" id="morningShift"
                                         value="Morning">
                                     <label class="form-check-label" for="morningShift">Morning</label>
                                 </div>
                                 <div class="form-check">
                                     <input class="form-check-input" type="radio" name="shift" id="dayShift"
                                         value="Day">
                         ...
                         <div class="col-md-4">
                             ...
                             <input type="number" step="0.01" name="cgpa" class="form-control custom-input"
                                 placeholder="0.00">
                         </div>
                         ...
                         <div class="col-12">
                             ...
                             <div class="upload-box p-3 border rounded text-center bg-white">
                                 <input type="file" name="image" class="form-control mb-2 shadow-none border-0"
                                     id="imgInput">
